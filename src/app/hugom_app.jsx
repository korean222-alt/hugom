...
function PromotionCard({ profile, rank, hobon, onClose }) {
  ...
  const drawCard = (ctx) => {
    ...
    const emojiSrc = document.createElement("canvas");
    emojiSrc.width = 160; emojiSrc.height = 160;
    const ectx = emojiSrc.getContext("2d");
...
export default function App() {
  ...
  const didInitTabRef = useRef(false); // 곰신 최초 진입 시 기본 탭을 "home"으로 한 번만 지정
